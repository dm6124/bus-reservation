...
void busLists()
{
  ...
  printf("-----------------------------------------------------------------------------------------");
  resetColor();
  printf("\n1\tjefforon traversal         \tthoothukudi to chennai       \tRs.1200   \t\t07:00  AM");
  printf("\n2\tDEV Travels     \tmadurai To chennai       \tRs.1000    \t\t01:30  PM");
  printf("\n3\tdival Travels   \tpondy To chennai\tRs.40    \t\t03:50  PM");
  printf("\n4\tSuper Deluxe         \tgoa To pondy    \tRs.2500    \t\t01:00  AM");
  printf("\n5\tSai Baba Travels     \tthoothukudi To kannyakumari \tRs.1300    \t\t12:05  AM");
  printf("\n6\taara On Travels     \tdindugal to trichy    \tRs.400    \t\t09:30  AM");
  printf("\n7\tpraveen Travels        \tkerala To munnar         \tRs.700   \t\t11:00  PM");
  printf("\n8\ts e t c Travels       \tkerala To kodaikannal     \tRs.750    \t\t08:15  AM");
  printf("\n9\torgange Travels        \tchennai To banglore       \tRs.850    \t\t04:00  PM");
  printf("\n");
